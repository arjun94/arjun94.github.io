...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnDrawHead( oSettings )
		{
			...
			if ( oSettings.oFeatures.bSort )
			{
				...
				// Prince Francis.
					...
					{
					// The following if-else condition is added by Prince Francis.
						if(!$(oSettings.aoColumns[i].nTh).hasClass('nosorting')){
							_fnSortAttachListener( oSettings, oSettings.aoColumns[i].nTh, i );
						} else{
							$(oSettings.aoColumns[i].nTh).removeClass('sorting');
						}
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = oSettings.oLanguage.sSearch+sSpace+'<input type="text" style="width:150px;"/>';
